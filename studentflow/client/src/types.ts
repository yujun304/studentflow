...
export interface EventItem { id: string; title: string; date: string; dateKey?: string; time: string; location: string; department: string; description: string; capacity?: number; participants: string[]; participantIds?: string[]; owner: string; status: "모집 중" | "마감" | "예정"; }
